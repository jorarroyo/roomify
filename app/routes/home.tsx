        ...
        <Navbar />
          <section className="hero">
              ...
              <p className="subtitle">
                  Roomify is an AI-first design environment that helps you visualize, render, adn ship architectural projects faster than ever.
              </p>
